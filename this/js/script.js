...
/*function context (a, b) {
    console.log(this);  // undefind || global this
...
/*const obj = {
    ...
    num3: 22,
    calc: function () {
        console.log(this.num1 + this.num2); // obj => context
    }
};
...
const sum = double.bind(2); // այստեղ double-ի this-ը դնում ենք 2 

console.log(sum(3)); // մենք այստեղ double-ի N-ը դնում ենք ինչ-որ թիվ
console.log(sum(7)); // մենք այստեղ double-ի N-ը դնում ենք ինչ-որ թիվ
console.log(sum(9)); // մենք այստեղ double-ի N-ը դնում ենք ինչ-որ թիվ
*/
